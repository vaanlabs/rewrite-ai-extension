// groq.js — Groq API integration (free, OpenAI-compatible)
// Groq hosts open-source models (Llama, Gemma, Mixtral) for free with no credit card.
// Sign up at console.groq.com to get an API key.

const GROQ_API_URL = 'https://api.groq.com/openai/v1/chat/completions';

/**
 * Call Groq's API to rewrite text.
 ...
 */
export async function callGroq(text, apiKey, model, style) {
